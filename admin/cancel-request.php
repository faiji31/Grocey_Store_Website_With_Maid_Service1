...
<html lang="en">
   <head>
      <title>Grocery Store and Maid Service || Assign Request</title>
      ...
      <div class="flex min-h-screen bg-gray-100">
         ...
         <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6 md:p-10">
               <h2 class="text-3xl font-bold text-green-700 mb-8">Cancel Request</h2>
               <div class="mb-10">
                  <div class="bg-white rounded-xl shadow p-6 mb-8">
                     <h3 class="text-xl font-semibold text-green-700 mb-4">Cancelled Maid Bookings</h3>
                     <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                           ...
                           <tbody class="bg-white divide-y divide-gray-200">
                              ...
                              <?php $cnt=$cnt+1; } } else { ?>
                              <tr>
                                 <td colspan="8" class="text-center py-4 text-gray-500">No Cancelled Requests Found</td>
                              </tr>
                              <?php } ?>
                           </tbody>
                        </table>
                  ...
                  <div class="bg-white rounded-xl shadow p-6">
                     <h3 class="text-xl font-semibold text-green-700 mb-4">Cancelled Grocery Orders</h3>
                     <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                           <thead class="bg-green-600">
                              <tr>
                           ...
                           <tbody class="bg-white divide-y divide-gray-200">
                              ...
                              <?php $cnt=$cnt+1; } } else { ?>
                              <tr>
                                 <td colspan="9" class="text-center py-4 text-gray-500">No Cancelled Requests Found</td>
                              </tr>
                              <?php } ?>
                           </tbody>
                        </table>
