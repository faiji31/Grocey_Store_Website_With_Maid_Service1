    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6 md:p-10">
                <h2 class="text-3xl font-bold text-green-700 mb-8">All Requests</h2>
                <div class="mb-10">
                    <div class="bg-white rounded-xl shadow p-6 mb-8">
                        <h3 class="text-xl font-semibold text-green-700 mb-4">Maid Booking Requests</h3>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 text-sm text-gray-900"><?php echo htmlentities($row->Status ? $row->Status : 'Not Updated Yet'); ?></td>
                                        <td class="px-4 py-2 text-sm text-gray-900"><?php echo htmlentities($row->AssignTo ? $row->AssignTo : 'Not Assigned Yet'); ?></td>
                                    </tr>
                                    <?php $cnt = $cnt + 1; }
                                    } ?>
                                </tbody>
                    ...
                    <div class="bg-white rounded-xl shadow p-6">
                        <h3 class="text-xl font-semibold text-green-700 mb-4">Grocery Booking Requests</h3>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-green-600">
                                    <tr>
                                        ...
                                        <th class="px-4 py-2 text-left text-xs font-bold text-white uppercase tracking-wider">User Name</th>
