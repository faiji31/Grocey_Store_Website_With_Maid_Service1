...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-h-screen" style="min-width:0;">
        ...
        <main class="flex-1 p-6 md:p-10 mt-4">
            <h2 class="text-3xl font-bold text-green-700 mb-8">Cancelled Grocery Orders</h2>
            <div class="bg-white rounded-xl shadow-lg p-8">
                <h3 class="text-xl font-semibold text-green-700 mb-4">Orders Cancelled</h3>
                        ...
                        <tbody class="bg-white divide-y divide-green-100">
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-red-600 font-semibold"><?php echo htmlentities($row->Status); ?></td>
                                    <td class="px-4 py-2 text-gray-600"><?php echo htmlentities($row->AssignTo); ?></td>
                                </tr>
                                                <?php
                                                    }
                            } else {
                                echo '<tr><td colspan="8" class="px-4 py-2 text-center text-gray-400">No cancelled orders found.</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
